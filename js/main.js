...
async function initMap() {
  ...
  let map = new YMap(document.getElementById("location-map"), {
    location: {
      center: markerCoords,
      zoom: 15
    }
...
var burger = __webpack_require__(604);
...
;// CONCATENATED MODULE: ./src/js/components/hero-slider.js

core.use([Navigation, Pagination, EffectFade]);
const sliderEl = document.querySelector(".hero__slider");
if (sliderEl) {
  let heroSlider = new core(sliderEl, {
    slidesPerView: 1,
    speed: 1000,
    loop: true,
    navigation: {
...
core.use([Pagination, EffectFade]);
const types_slider_sliderEl = document.querySelector(".types__slider");
if (types_slider_sliderEl) {
  let types = ["M", "A1", "A", "B", "C", "D", "BE", "CE", "DE", "САМОХОДНЫЕ ТС"];
  let typesSlider = new core(types_slider_sliderEl, {
    spaceBetween: 30,
    slidesPerView: 1,
    speed: 600,
    effect: "fade",
...
;// CONCATENATED MODULE: ./src/js/components/staff-slider.js

core.use([Navigation]);
const staff_slider_sliderEl = document.querySelector(".staff__slider");
if (staff_slider_sliderEl) {
  let staffSlider = new core(staff_slider_sliderEl, {
    speed: 600,
    breakpoints: {
      1441: {
        slidesPerView: 3,
...
;// CONCATENATED MODULE: ./src/js/components/comms-slider.js

core.use([Navigation]);
const comms_slider_sliderEl = document.querySelector(".comms__slider");
if (comms_slider_sliderEl) {
  let staffSlider = new core(comms_slider_sliderEl, {
    speed: 600,
    spaceBetween: 30,
    breakpoints: {
      1441: {
